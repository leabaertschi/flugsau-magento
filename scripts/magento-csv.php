...
$fh = fopen('./output/magent-products.csv', 'w');
$title_row = [
    'sku',
    'store_view_code',
    'attribute_set_code',
...
foreach ($items as $item) {
    ...
    $item_desc = itemDescription($item, $items_description);
    $item_options = itemOptions($item, $items_characteristics, $items_options, $items_options_values);
