...
namespace Customweb\TwintCw\Observer\ExternalCheckout;
...
{
	/**
	 * @var \Customweb\TwintCw\Model\ExternalCheckout\Widget\Collection
	 */
	protected $_widgetCollection;

	/**
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	 */
	public function __construct(
			\Customweb\TwintCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	) {
