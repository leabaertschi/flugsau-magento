...
class View extends \Customweb\TwintCw\Controller\Adminhtml\Transaction
{
	public function execute()
	{
		...
		if ($transaction) {
			...
			$resultPage->getConfig()->getTitle()->prepend(__('TWINT Transactions'));
			$resultPage->getConfig()->getTitle()->prepend(sprintf("#%s", $transaction->getIncrementId()));
			return $resultPage;
		}
		$resultRedirect->setPath('twintcw/transaction/');
