...
namespace Customweb\TwintCw\Controller\Adminhtml\Config;

class Save extends \Customweb\TwintCw\Controller\Adminhtml\Config
{
	...
	private function storeConfigState()
	{
		...
		$storedConfigState = $storage->read(\Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY);
		...
		$storage->write(\Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY, $updatedConfigState);
	}
