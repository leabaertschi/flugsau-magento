...
class GuestPost extends \Customweb\TwintCw\Controller\ExternalCheckout
{
	...
	public function execute()
	{
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
			$data = [
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST))) {
