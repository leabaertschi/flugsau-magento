...
class RegisterPost extends \Customweb\TwintCw\Controller\ExternalCheckout
{
	...
	{
		if (!($this->getContext() instanceof \Customweb\TwintCw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
