...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\TwintCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\TwintCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\TwintCw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\TwintCw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\TwintCw\Model\DependencyContainer $container
	 * @return \Customweb\TwintCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\TwintCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\TwintCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\TwintCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('twintcw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('twintcw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\TwintCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['twintcw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_twintcw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			$transaction = $this->_coreRegistry->registry('twintcw_transaction');
