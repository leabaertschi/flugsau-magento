...
namespace Customweb\TwintCw\Model\ExternalCheckout;

/**
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\TwintCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\TwintCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\TwintCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_external_checkout_context';
	...
	/**
	 * @var \Customweb\TwintCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function __construct(
			...
			\Customweb\TwintCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\TwintCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\TwintCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\TwintCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\TwintCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\TwintCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\TwintCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\TwintCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\TwintCw\Model\Payment\Method\AbstractMethod) {
			$data = [
