 ...
 * @method \Customweb\TwintCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\TwintCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\TwintCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_storage';
    ...
    {
        $this->_init('Customweb\TwintCw\Model\ResourceModel\Storage');
    }
