...
namespace Customweb\TwintCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/twintcw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('twintcw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('twintcw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
