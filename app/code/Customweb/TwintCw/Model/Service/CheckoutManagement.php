...
class CheckoutManagement implements \Customweb\TwintCw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\TwintCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\TwintCw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\TwintCw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\TwintCw\Model\Exception\OptimisticLockingException
     */
    ...
    /**
     *
     * @param \Customweb\TwintCw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\TwintCw\Api\Data\AuthorizationFormFieldInterface $formValue */
