...
class TransactionRepository implements \Customweb\TwintCw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\TwintCw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\TwintCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\TwintCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\TwintCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\TwintCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\TwintCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\TwintCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\TwintCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\TwintCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
