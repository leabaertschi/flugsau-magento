...
class AuthorizationData implements \Customweb\TwintCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\TwintCw\Model\Service\AuthorizationFormField();
