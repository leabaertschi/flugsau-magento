...
namespace Customweb\TwintCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\TwintCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\TwintCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_twintcw_transaction', 'entity_id');
    }
