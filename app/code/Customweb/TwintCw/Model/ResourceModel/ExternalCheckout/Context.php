...
namespace Customweb\TwintCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\TwintCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_twintcw_external_checkout_context', 'context_id');
    }
