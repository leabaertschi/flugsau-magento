...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\TwintCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\TwintCw\Model\Authorization\Transaction $transaction)
	{
