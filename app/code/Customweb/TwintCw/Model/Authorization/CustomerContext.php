 ...
 * @method \Customweb\TwintCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\TwintCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\TwintCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\TwintCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_customer_context';
	 ...
	 * @param \Customweb\TwintCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\TwintCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\TwintCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\TwintCw\Model\Authorization\CustomerContext
     */
