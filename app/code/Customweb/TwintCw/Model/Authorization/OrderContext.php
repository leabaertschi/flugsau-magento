...
class OrderContext implements \Customweb_Payment_Authorization_IOrderContext
{
	 ...
	 * @param \Customweb\TwintCw\Model\Payment\Method\AbstractMethod|string $paymentMethod
	 * @throws \Exception
	 */
	...
	private function assembleDataFromQuote(
		...
		$checkoutId = $checkoutSession->getTwintCwCheckoutId();
		if(empty($checkoutId)){
			$checkoutId = \Customweb_Core_Util_Rand::getUuid();
			$checkoutSession->setTwintCwCheckoutId($checkoutId);
		}
