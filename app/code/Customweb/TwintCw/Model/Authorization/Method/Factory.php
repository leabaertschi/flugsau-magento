...
class Factory
{
     ...
     */
    public function create(\Customweb\TwintCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\TwintCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\TwintCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\TwintCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\TwintCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\TwintCw\Model\Authorization\Method\Context\Factory
     */
