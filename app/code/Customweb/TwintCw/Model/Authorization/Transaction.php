...
namespace Customweb\TwintCw\Model\Authorization;

use \Customweb\TwintCw\Api\Data\TransactionInterface;
use Magento\Customer\Model\Customer;

/**
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\TwintCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_twintcw_transaction';
	...
	/**
	 * @var \Customweb\TwintCw\Model\Authorization\Method\Factory
	 */
	...
	{
		$this->_init('Customweb\TwintCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\TwintCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\TwintCw\Model\Authorization\Method\AbstractMethod */
