 ...
 *
 */
namespace Customweb\TwintCw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\TwintCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\TwintCw\Block\Payment\Method\Info';
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		if ($transaction instanceof \Customweb\TwintCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('twintcw/checkout/error', [
			'_secure' => true,
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('twintcw_authorization_transaction');
		if ($transaction instanceof \Customweb\TwintCw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('twintcw_invoice');
	...
	private function captureItems(\Customweb\TwintCw\Model\Authorization\Transaction $transaction, $items = [])
	{
