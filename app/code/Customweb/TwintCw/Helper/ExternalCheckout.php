...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	...
	/**
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Context $context
	...
	public function saveOrder(\Customweb\TwintCw\Model\ExternalCheckout\Context $context)
	{
		...
		switch ($context->getRegisterMethod()) {
			case \Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\TwintCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\TwintCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\TwintCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\TwintCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\TwintCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\TwintCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
