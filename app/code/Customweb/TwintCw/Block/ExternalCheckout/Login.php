...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TwintCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('twintcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('twintcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('twintcw/externalCheckout/registerPost', ['_secure' => true]);
	}
