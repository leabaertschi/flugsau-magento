...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TwintCw::payment/method/info.phtml';
	...
	public function getMethod()
	{
		...
		if ($this->getTransaction() instanceof \Customweb\TwintCw\Model\Authorization\Transaction) {
	...
	{
		return $this->getUrl('twintcw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
