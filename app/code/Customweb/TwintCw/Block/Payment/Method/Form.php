...
namespace Customweb\TwintCw\Block\Payment\Method;
...
class Form extends \Magento\Payment\Block\Form
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TwintCw::payment/method/form.phtml';
	...
	public function getPaymentForm()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_TwintCw_License::run('r8rf6gmihlpr8tgl', $this, $arguments);
	}

	final public function call_hihv01brqvthn5q2() {
	...
	private function getFormRenderer() {
		return new \Customweb\TwintCw\Model\Renderer\CheckoutForm($this->getMethodCode());
	}
	...
	{
		if (!($this->authorizationMethodAdapter instanceof \Customweb\TwintCw\Model\Authorization\Method\AbstractMethod)) {
