...
namespace Customweb\TwintCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	 ...
	 * @var string
	 */
	protected $_blockGroup = 'Customweb_TwintCw';
	...
	protected function _construct()
	{
		...
		$this->setId('twintcw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('twintcw_transaction');
	}
	...
	{
		return $this->getUrl('twintcw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('twintcw/transaction/');
	}
}