...
namespace Customweb\TwintCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TwintCw::twintcw/config/form.phtml';

	/**
	 * @var \Customweb\TwintCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\TwintCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\TwintCw\Model\Config\Structure $formStructure,
			\Customweb\TwintCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
