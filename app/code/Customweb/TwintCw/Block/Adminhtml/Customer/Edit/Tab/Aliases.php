...
namespace Customweb\TwintCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\TwintCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\TwintCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
     * @param \Customweb\TwintCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
    		...
    		\Customweb\TwintCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    		\Customweb\TwintCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $collectionFactory,
    		array $data = []
    ) {
    ...
    {
    	parent::_construct();
    	$this->setId('twintcw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('twintcw/customer/aliases', ['_current' => true]);
    }
