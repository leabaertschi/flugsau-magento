...
class Aliases extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Customweb\TwintCw\Model\ResourceModel\Authorization\Transaction\Collection
     */
    protected $aliases;
    ...
    {
        parent::_construct();
        $this->pageConfig->getTitle()->set(__('My TWINT Aliases'));
    }
     ...
     * @return string
     */
    public function getDeleteUrl(\Customweb\TwintCw\Model\Authorization\Transaction $transaction)
    {
        return $this->getUrl('twintcw/customer/deleteAlias', ['id' => $transaction->getId()]);
    }
